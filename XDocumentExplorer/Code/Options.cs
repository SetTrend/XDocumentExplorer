...
namespace XDocumentExplorer.Code
{
	...
	public class Options
	{
		...
		public Options(Options other)
			=> (_mruFiles, _findReplArgs, _xmlSaveOptions, _tabSize, _replaceTabs)
			= (new MruFileList(other._mruFiles), other._findReplArgs, other._xmlSaveOptions, other._tabSize, other._replaceTabs);
